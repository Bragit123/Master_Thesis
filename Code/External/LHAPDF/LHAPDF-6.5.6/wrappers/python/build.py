...
## Build dirs
srcdir = os.path.abspath("/Users/brageandreastrefjord/Desktop/Github/Master_Thesis/Code/External/LHAPDF/LHAPDF-6.5.6/src")
libdir = os.path.abspath("/Users/brageandreastrefjord/Desktop/Github/Master_Thesis/Code/External/LHAPDF/LHAPDF-6.5.6/src/.libs")
incdirs = [os.path.abspath("/Users/brageandreastrefjord/Desktop/Github/Master_Thesis/Code/External/LHAPDF/LHAPDF-6.5.6/include"),
           os.path.abspath("/Users/brageandreastrefjord/Desktop/Github/Master_Thesis/Code/External/LHAPDF/LHAPDF-6.5.6/include")]

## The extension source file (built by separate Cython call)
srcname = "lhapdf.cpp"
srcpath = os.path.join("/Users/brageandreastrefjord/Desktop/Github/Master_Thesis/Code/External/LHAPDF/LHAPDF-6.5.6/wrappers/python", srcname)
if not os.path.isfile(srcpath): # distcheck has it in srcdir
    srcpath = os.path.join("/Users/brageandreastrefjord/Desktop/Github/Master_Thesis/Code/External/LHAPDF/LHAPDF-6.5.6/wrappers/python", srcname)

## Include args
incargs = " ".join("-I{}".format(d) for d in incdirs)
incargs += " -I/Users/brageandreastrefjord/Desktop/Github/Master_Thesis/Code/External/LHAPDF/LHAPDF-6.5.6/../include"
incargs += "  -I/Users/brageandreastrefjord/Desktop/Github/Master_Thesis/Code/External/LHAPDF/LHAPDF-6.5.6/../include"
...
linkargs = " -L/Users/brageandreastrefjord/Desktop/Github/Master_Thesis/Code/External/LHAPDF/LHAPDF-6.5.6/src/.libs" if "LHAPDF_LOCAL" in os.environ else "-L/Users/brageandreastrefjord/Desktop/Github/Master_Thesis/Code/External/LHAPDF/LHAPDF-6.5.6/../lib"
linkargs += "  -L/Users/brageandreastrefjord/Desktop/Github/Master_Thesis/Code/External/LHAPDF/LHAPDF-6.5.6/../lib"
...
import subprocess
sys.exit(subprocess.call(compile_cmd.split(), cwd="/Users/brageandreastrefjord/Desktop/Github/Master_Thesis/Code/External/LHAPDF/LHAPDF-6.5.6/wrappers/python/build/lhapdf"))
