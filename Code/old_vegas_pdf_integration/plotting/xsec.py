...
for slepton_id in slepton_ids:
  ...
  m_arrs.append(m_arr)
  xsec_lo_arrs.append(xsec_lo * gev_to_fb)
  xsec_nlo_arrs.append(xsec_nlo * gev_to_fb)
  xsec_hadron_arrs.append(xsec_hadron * gev_to_fb)
  xsec_slepton_arrs.append(xsec_slepton * gev_to_fb)
