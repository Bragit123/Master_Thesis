...
int CrossSection::integrand_slepton_x1_x2_Q(
  ...
  // std::cout << xfqbar_x2 << " | " << xfqbar_tau_x1 << " || " << w_plus_1 << " | " << w_plus_1_one << std::endl;
  // std::cout << f1 << " | " << f1_term << " | " << f_term << std::endl;
  // std::cout << born << " | " << jacobian << " | " << rad_term << " | " << f_term << std::endl;
...
double CrossSection::full_xsec(
  ...
  for (int quark_id_ : all_quark_ids) {
    ...
    if (subset == 0) {
      ...
      // std::cout << integral1[0] << " | " << integral2[0] << std::endl;
    }
  }
